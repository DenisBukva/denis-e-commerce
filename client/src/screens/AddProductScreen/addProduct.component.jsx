...
const ProductEditScreen = ({ match, history }) => {
    ...
    const [countInStock, setCountInStocek] = useState(0);
    ...
    useEffect(() => {
        if (successUpdate) {
            ...
            if (!product.name || product._id !== productId) {
                ...
                setCountInStocek(product.countInStock);
            ...
            <FormContainer>
                ...
                {loading ? (
                    ...
                    <Form onSubmit={submitHandler}>
                        ...
                        <Form.Group controlId='image' onChange={uploadImageHandler} className='mt-3'>
                        ...
                        <Form.Group controlId='countInStock' className='mt-3'>
                            ...
                            <Form.Control
                                ...
                                value={countInStock}
                                onChange={(e) => setCountInStocek(e.target.value)}
                            ></Form.Control>
                        </Form.Group>
